...
namespace Earthquake
{
    public class Class1 : ISub {
		...
		public string description => "Rapidly moves and resizes the currently activated window.";
		public string author => "Christian Kosman";
		public string version => "1.0.0";
		public bool enabled { get; set; } = false;
		public Type settings { get => typeof(EarthquakeSettings); }
		...
		public void SubMethod(dynamic settings) {
			...
			while (true) {
				...
				MoveWindow(foregroundWindow, rect.Left + rand.Next(-settings.intensity, settings.intensity), rect.Top + rand.Next(-settings.intensity, settings.intensity), rect.Width + rand.Next(-settings.intensity, settings.intensity), rect.Height + rand.Next(-settings.intensity, settings.intensity), true);
